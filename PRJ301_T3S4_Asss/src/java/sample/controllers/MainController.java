...
public class MainController extends HttpServlet {
    ...
    private static final String LOG_OUT = "login.html";
...
//                String flowerId = request.getParameter("cmbFlower");
//                int quantity = Integer.parseInt(request.getParameter("cmbQuantity"));
//
//                try {
//                    UserDAO userDAO = new UserDAO();
//                    userDAO.checkout(flowerId, quantity, request);
//
//                    request.setAttribute("MESSAGE", "Your order has been successfully checked out.");
//                } catch (SQLException e) {
//                    request.setAttribute("MESSAGE", "An error occurred while checking out your order.");
//                }
//
//                url = SHOPPING_PAGE_VIEW;
